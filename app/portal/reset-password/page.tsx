      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl shadow-slate-200/50 overflow-hidden">
        ...
        <div className="p-8 pt-10">
          <form onSubmit={handleReset} className="space-y-5">
            ...
            {message && (
              <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl text-xs font-bold leading-relaxed flex items-center gap-2">
          ...
          <p className="text-center text-sm text-slate-500 mt-8 font-medium">
            Remembered your password? <Link href="/portal/login" className="text-blue-600 hover:underline">Log in</Link>
          </p>
        </div>
      </div>
    </div>
